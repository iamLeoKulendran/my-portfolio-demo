...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    description:
      "Experienced in Spring Boot API deployment, cloud hosting, and Docker containerization. Proficient in VPS cloud setup and configuration, managing Linux servers, CI/CD pipelines, and Git/GitHub to streamline development and testing environments. Skilled in using AWS for cloud infrastructure management.",
  },
  {
    id: 2,
    ...
    description:
      "Worked under micro-service architecture Create REST API using .NET 6, Swager API testing Worked on Telerik reporting and DevExpress Built and deployed Docker containers Experienced in Azure Cloud environment.",
  },
  {
    id: 1,
    ...
    description:
      "Worked in the Loan and Recovery sections, responsible for creating loan accounts and managing the filing of loan documents.",
  },
];
...
const achievements: Achievement[] = [
  {
    ...
    status: "in-progress",
    description:
      "Preparing for the CKA certification to validate my skills in managing Kubernetes clusters and workloads.",
  ...
  },
  {
    ...
    status: "completed",
    description:
      "Earned multiple badges on AWS services, including Compute, Storage, Security and Network.",
  ...
  },
  {
    ...
    status: "in-progress",
    description:
      "Completed multiple hands-on labs and courses on Kubernetes, Docker, Terraform, Ansible, Linux, MLOps and DevOps practices.",
  ...
  },
  {
    ...
    status: "completed",
    description:
      "Fundamental-level certification for understanding cloud concepts and services on Azure.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-1">
            <div className="sticky top-28 space-y-8">
              <div
                className="relative w-64 h-64 mx-auto lg:mx-0 rounded-full overflow-hidden border-4 border-background shadow-xl animate-fade-in opacity-0"
              ...
              >
                ...
                <p className="text-muted-foreground text-center lg:text-left">
                  DevOps Engineer | BSc (Hons) in Information Technology | Cloud
                  Enthusiast Passionate about automation, cloud infrastructure,
                  and CI/CD. Skilled in Kubernetes, Docker, and Linux, I
                  specialize in building scalable, reliable systems and
                  streamlining deployments for efficiency and performance.
                </p>
                ...
                <div className="flex flex-wrap gap-4 pt-4 justify-center lg:justify-start">
                  <a
                    ...
                    }Leo Kulendran_DevOps_Engineer.pdf`}
                    target="_blank"
