  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Please contact me directly via email at leosiraj111@gmail.com",
        variant: "destructive",
      });
      setFormData({
        name: "",
    ...
    <Layout>
      <div className="section-container pt-10 md:pt-20 pb-20">
        <div className="text-center mb-12">
          <h1 className="heading-lg mb-4 animate-fade-in opacity-0" style={{ animationDelay: '0.1s' }}>
            Get in Touch
          </h1>
          <p className="body-lg text-muted-foreground max-w-2xl mx-auto animate-fade-in opacity-0" style={{ animationDelay: '0.3s' }}>
            Have a question or want to work together? Feel free to reach out!
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-1 space-y-8 animate-fade-in opacity-0" style={{ animationDelay: '0.5s' }}>
            ...
            <div className="glass-card p-6 md:p-8 rounded-2xl overflow-hidden border border-white/8 dark:border-white/8 bg-muted/10 dark:bg-slate-900/40 backdrop-blur-md shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] relative hover:translate-y-[-5px] hover:shadow-lg transition-all duration-300 ease-in-out">
              ...
              <p className="text-muted-foreground">
                I typically respond to messages within 12-24 hours. For urgent matters, please indicate so in your message.
              </p>
            </div>
          </div>

          <div className="lg:col-span-2 animate-fade-in opacity-0" style={{ animationDelay: '0.7s' }}>
