...
export const projects: Project[] = [
  {
    ...
    longDescription:
      "This project demonstrates a full-scale DevOps implementation on an E-Commerce platform using OpenTelemetrys Astronomy Shop. It covers the entire DevOps lifecycle, from infrastructure provisioning to CI/CD automation and monitoring.",
    tags: [
      "End-to-End DevOps",
      "CI/CD",
    ...
    githubUrl:
      "https://github.com/iamLeoKulendran/DevOps-Implementation-on-OpenTelemetry-Astronomy-Shop",
    liveUrl: "",
    hasLiveDemo: false,
    featured: true,
    status: "in-progress",
    ...
    screenshots: ["projects/OpenTelemetry Astronomy Shop.jpg"],
  },
  {
    id: 14,
    ...
    longDescription:
      "This project demonstrates a DevSecOps pipeline implementation for a Node.js Tic Tac Toe application using GitHub Actions. It ensures a secure, automated, and efficient CI/CD workflow with container security scanning, GitOps, and Kubernetes deployment.",
    ...
    githubUrl:
      "https://github.com/iamLeoKulendran/devsecops-demo-tic-tac-toe-game",
    liveUrl: "",
    hasLiveDemo: false,
    featured: true,
    status: "completed",
  ...
  },
  {
    ...
    longDescription:
      "This project focuses on deploying a microservices-based crypto application on AWS using industry best practices. It covers containerization, CI/CD automation, and scalable deployment strategies.",
    tags: [
      "End-to-End DevOps",
      "Cloud Migration",
      "Containerization & Orchestration",
    ...
    githubUrl:
      "https://github.com/iamLeoKulendran/Hands-On-AWS-Project-Deploy-Crypto-App",
    liveUrl:
      "https://github.com/iamLeoKulendran/Hands-On-AWS-Project-Deploy-Crypto-App",
    hasLiveDemo: false,
    featured: true,
    ...
    screenshots: ["projects/crypto app sr1.png", "projects/crypto app sr2.png"],
  },
  {
    id: 11,
    ...
    longDescription:
      "This hands-on project walks through an end-to-end DevOps lifecycle implementation on Google Cloud Platform (GCP). It follows a sprint-based approach, demonstrating how top companies manage software delivery using DevOps best practices.",
    tags: [
      "End-to-End DevOps",
      "CI/CD",
      "Containerization & Orchestration",
  ...
  },
  {
    id: 10,
    title:
      "Develop portfolio website using Prompt engineering technique and LLM",
    description: "LLM-powered React portfolio website",
    longDescription:
      "This project involved creating a portfolio website using advanced prompt engineering techniques and leveraging language models such as Locall-LLM (Quewn Corder and Deepseek) and GitHub Copilot. The application was built using React, Tailwind CSS, and Vite. Despite having limited React experience, the project was rapidly developed in less than a day by modifying an existing template with custom contact details and UI enhancements. It involved debugging routing and networking issues, setting up automated deployment with GitHub Actions, configuring DNS, and hosting on a custom domain (iamleo.net).",
    tags: ["Prompt Engineering", "Development", "LLM"],
    technologies: [
      "Prompt Engineering",
      "React",
      "Locall-LLM",
  ...
  },
  {
    ...
    longDescription:
      "This project showcases the use of ArgoCD for GitOps to automate the deployment and management of a Tetris game on a Kubernetes single-node cluster. It emphasizes seamless version management and application synchronization.",
  ...
  },
  {
    ...
    longDescription:
      "This project focuses on enhancing the handling of Out-of-Scope (OOS) queries in Large Language Models (LLMs) by integrating state-of-the-art methodologies. The goal is to improve accuracy and contextual relevance when dealing with user inputs beyond the model's knowledge domain.",
    tags: ["AI/ML"],
    technologies: [
      "Machine Learning",
      "Logistic Regression",
      "Vector Similarity Analysis",
      "AWS Titan Text Embedding",
      "RAG",
    ],
  ...
  },
  {
    ...
    longDescription:
      "A demonstration of Spring Security and OAuth2 implementation for Single Sign-On (SSO) authentication using JWT tokens.",
    tags: ["Development"],
  ...
  },
  {
    ...
    longDescription:
      "A cloud migration project demonstrating the 'Lift and Shift' strategy to move an on-premises web application to AWS EC2 instances.",
  ...
  },
  {
    ...
    longDescription:
      "A containerized version of the popular 2048 game, showcasing Docker for application deployment and Nginx for web serving.",
  ...
  },
  {
    ...
    longDescription:
      "A microservices application built with Spring Boot, showcasing service decomposition, containerization, and orchestration with Kubernetes.",
    ...
    githubUrl: "https://github.com/iamLeoKulendran",
    liveUrl:
      "https://github.com/iamLeoKulendran/Micro-services-Spring-boot-app",
    hasLiveDemo: false,
    featured: false,
    status: "completed",
    highlights: [
    ...
    screenshots: ["projects/microservices app.jpg"],
  },
  {
    id: 2,
    ...
    longDescription:
      "An Android mobile application for a cake shop that demonstrates Create, Update, Read, and Delete operations using Java.",
    tags: ["Development"],
    ...
    screenshots: ["projects/cake shop app - screenshot.png"],
  },
  {
    id: 1,
    ...
    longDescription:
      "A comprehensive system for managing employee expenses built with Laravel backend, MySQL database, and Flutter for the mobile frontend.",
    tags: ["Development"],
    technologies: ["Laravel", "MySQL", "Flutter"],
    image: "projects/Software Project.jpg",
    githubUrl: "https://github.com/iamLeoKulendran",
    liveUrl:
      "https://github.com/iamLeoKulendran/Employee-Expense-Management-System",
    hasLiveDemo: false,
    featured: false,
    status: "completed",
    highlights: [
    ...
    screenshots: ["projects/Software Project.jpg"],
  },
];
