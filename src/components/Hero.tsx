    ...
    <div className="relative overflow-hidden min-h-[91.5vh] w-full max-w-[1600px] mx-auto flex items-center pt-8">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 md:space-y-8 text-center lg:text-left">
          ...
          <Link
            to="/about"
            className="inline-block mb-6 animate-fade-in opacity-0 hover:scale-105 transition-transform"
          ...
          <div
            className="inline-block rounded-full bg-muted px-4 py-2 text-base font-medium mb-6 animate-fade-in opacity-0"
          ...
          <h1
            className="heading-xl mb-6 animate-fade-in opacity-0 text-balance"
            style={{ animationDelay: "0.5s" }}
          >
            Automating Excellence in{" "}
            <span className="text-primary">DevOps Engineering</span>
          </h1>

          <p
            className="body-lg text-muted-foreground mb-8 max-w-2xl mx-auto lg:mx-0 animate-fade-in opacity-0 text-balance"
            style={{ animationDelay: "0.7s" }}
          >
            Specialized in building scalable infrastructure, CI/CD pipelines,
            and cloud-native solutions to accelerate development and streamline
            operations.
          </p>
